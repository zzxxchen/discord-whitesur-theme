# Discord WhiteSur Theme

A WhiteSur theme for Discord, following the macOS WhiteSur style (with whatever the Discord CSS lets me do).
...
```
https://raw.githubusercontent.com/zzxxchen/discord-whitesur-theme/master/whitesur.theme.css
```

If you'd like to configure it, put [whitesur.theme.css][css-main] in `~/.config/vesktop/themes`. It's still updated automatically.
